...
{
    [Serializable]
    public struct float2_temporal4
    {
        ...
        public bool hasDifference4 => (math.abs(_value3 - _value4) > float2c.epsilon).all();
